...
const Contact = () => {
  ...
  const handleSubmit = () => {
    alert("Thank u so much for contacting me..");
    setShowPopup(true);
    ...
    <div name='contact' className='w-full min-h-screen bg-gradient-to-r from-black to-blue-900 flex justify-center items-center p-4 overflow-x-hidden'>
      <div className='flex flex-col max-w-[600px] w-full'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit} >
          <input type='hidden' name='access_key' value='21bd6502-3fa9-4ec4-b179-386268c50aab' required />
        ...
        <div className='flex flex-col sm:flex-row justify-center space-x-0 sm:space-x-4 space-y-4 sm:space-y-0 mt-8'>
          ...
          <a
            href='https://github.com/Mishra-je'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-300 hover:text-white flex items-center'
          >
          ...
          <a
            href='mailto:skumarmishra579@gmail.com'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-300 hover:text-white flex items-center'
          >
