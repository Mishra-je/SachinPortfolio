  ...
  return (
    <div name='home' className='w-full h-screen bg-gradient-to-r from-black to-blue-900 ... overflow-x-hidden'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        I'm a MERN stack developers play a crucial role in modern web development, combining their expertise in front-end and back-end technologies to create seamless and efficient web applications.
        </p>
        <div>
